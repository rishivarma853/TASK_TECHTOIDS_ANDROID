...
import ca.lcit22fw.madt.techtoids.android.nota_app.adapter.AttachmentAdapter;
import ca.lcit22fw.madt.techtoids.android.nota_app.databinding.ActivityAddTaskBinding;
import ca.lcit22fw.madt.techtoids.android.nota_app.databinding.AttachmentItemBinding;
...
public class AddTaskActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        this.menu = menu;
        inflater.inflate(ca.lcit22fw.madt.techtoids.android.nota_app.R.menu.add_task_menu, menu);
        updateUI();
        return true;
    }
